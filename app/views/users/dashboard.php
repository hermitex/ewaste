...
<div class="sidebar">
    <div class="logo-details">
        ...
        <span class="logo_name">eWaste</span>
    </div>
    <ul class="nav-links">
        <li>
            <a href="#" class="active">
        ...
        <li>
            <a href="#">
                ...
                <span class="links_name">Pick Up Requests</span>
            </a>
        </li>
        <li>
            <a href="#">
        ...
        <li>
            <a href="<?php echo URLROOT;?>/locations/location">
        ...
        <li>
            <a href="<?php echo URLROOT; ?>/users/userlist">
...
<section class="home-section">
    <nav>
        ...
        <div class="profile-details">
            ...
            <span class="admin_name"><?php echo $_SESSION['first_name']?></span>
        ...
        <div class="overview-boxes">
            <div class="box">
                <div class="right-side">
                    <div class="box-topic">Pick Up Requests</div>
            ...
            <div class="box">
                <div class="right-side">
                    <div class="box-topic">Drop Off Requests</div>
